globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///home/elham/Documents/github%20repositories/FrontEndMentor/Multi-Step-Form/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///home/elham/Documents/github%20repositories/FrontEndMentor/Multi-Step-Form/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, getRequestHeaders, setResponseHeader, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery, createError } from 'file:///home/elham/Documents/github%20repositories/FrontEndMentor/Multi-Step-Form/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///home/elham/Documents/github%20repositories/FrontEndMentor/Multi-Step-Form/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///home/elham/Documents/github%20repositories/FrontEndMentor/Multi-Step-Form/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file:///home/elham/Documents/github%20repositories/FrontEndMentor/Multi-Step-Form/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///home/elham/Documents/github%20repositories/FrontEndMentor/Multi-Step-Form/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///home/elham/Documents/github%20repositories/FrontEndMentor/Multi-Step-Form/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///home/elham/Documents/github%20repositories/FrontEndMentor/Multi-Step-Form/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/elham/Documents/github%20repositories/FrontEndMentor/Multi-Step-Form/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///home/elham/Documents/github%20repositories/FrontEndMentor/Multi-Step-Form/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///home/elham/Documents/github%20repositories/FrontEndMentor/Multi-Step-Form/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///home/elham/Documents/github%20repositories/FrontEndMentor/Multi-Step-Form/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery } from 'file:///home/elham/Documents/github%20repositories/FrontEndMentor/Multi-Step-Form/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/elham/Documents/github%20repositories/FrontEndMentor/Multi-Step-Form/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/elham/Documents/github%20repositories/FrontEndMentor/Multi-Step-Form/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/elham/Documents/github%20repositories/FrontEndMentor/Multi-Step-Form/node_modules/radix3/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/home/elham/Documents/github repositories/FrontEndMentor/Multi-Step-Form/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/elham/Documents/github repositories/FrontEndMentor/Multi-Step-Form","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/elham/Documents/github repositories/FrontEndMentor/Multi-Step-Form/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/elham/Documents/github repositories/FrontEndMentor/Multi-Step-Form/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/elham/Documents/github repositories/FrontEndMentor/Multi-Step-Form/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_UFBptP = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_UFBptP, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_UFBptP, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('/home/elham/Documents/github repositories/FrontEndMentor/Multi-Step-Form/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/home/elham/Documents/github repositories/FrontEndMentor/Multi-Step-Form/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
...
const _virtual__headStatic = {"headTags":"<meta charset=\"utf-8\">\n<title>Home | Multi Step Form</title>\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=0.9\">\n<meta name=\"description\" content=\"\">\n<meta name=\"author\" content=\"\">\n<meta name=\"og:site_name\" content=\"\">\n<meta name=\"og:url\" content=\"\">\n<meta name=\"og:title\" content=\"\">\n<meta name=\"og:description\" content=\"\">\n<meta name=\"og:image\" content=\"\">\n<meta name=\"twitter:url\" content=\"\">\n<meta name=\"twitter:title\" content=\"\">\n<meta name=\"twitter:description\" content=\"\">\n<meta name=\"twitter:image\" content=\"\">\n<link rel=\"stylesheet\" type=\"text/css\" href=\"/css/bootstrap-grid.css\">\n<link rel=\"icon\" type=\"image/x-icon\" href=\"/svgs/logo.png\">","bodyTags":"","bodyTagsOpen":"","htmlAttrs":" lang=\"en\"","bodyAttrs":""};
